  ...
  <div class="hello">
    ...
    <form action="">
      ...
      <div class="form-group">
        <button v-on:click="doLogin" class="btn btn-login login form-control">登录</button>
      </div>
      <div class="form-group">
        <button v-on:click="register" class="btn btn-reg register form-control">注册</button>
      </div>
    </form>
